...
Tuples are collections of items where items have serial numbers, but they can't be changed - No add/remove/reorder. Tuples are like a necklace. Once you create them you can't change them. You can't add/remove items. You can't reorder items.</p>
...
### <span style="color: darkgreen; font-family: Comic Sans MS, sans-serif;"> Ordered</span>

Tuple items have serial numbers. And they change. The first item stays first, the second stays second, and so on.
...
### <span style="color: darkgreen; font-family: Comic Sans MS, sans-serif;"> Immutable</span>
...
### <span style="color: darkgreen; font-family: Comic Sans MS, sans-serif;"> Can Contain Different Data Types</span>
...
### <span style="color: coral; font-family: 'Comic Sans MS', sans-serif;">Question - Tuple Containing a List</span>
...
### <span style="color: coral; font-family: 'Comic Sans MS', sans-serif;">Question - Immutable Tuples</span>
...
### <span style="color: coral; font-family: 'Comic Sans MS', sans-serif;">Question - Tuple Methods</span>
...
### <span style="color: coral; font-family: 'Comic Sans MS', sans-serif;">Question - Nested Tuples</span>
...
### <span style="color: coral; font-family: 'Comic Sans MS', sans-serif;">Question - Tuple Containment</span>
...
### <span style="color: coral; font-family: 'Comic Sans MS', sans-serif;">Question - Tuple Multiplication</span>
...
### <span style="color: coral; font-family: 'Comic Sans MS', sans-serif;">Question - Tuple with Mixed Types</span>
