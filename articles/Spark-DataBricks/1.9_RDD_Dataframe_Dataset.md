...
Imagine you have a Python list. Now, if we make this list capable of parallel processing, that’s an RDD. It’s just a collection of JVM objects that Spark can process in parallel.
...
- However, RDDs do not have type safety. This means you might run into runtime errors if your data types are not consistent.

**What is the type-safety issue with RDD:**
