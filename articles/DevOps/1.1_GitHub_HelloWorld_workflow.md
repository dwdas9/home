...
# <span style="color: DarkCyan;Font-family: Segoe UI, sans-serif;">Background</span>
...
## <span style="color: Teal;Font-family: Segoe UI, sans-serif;">Create an End-to-End GitHub Actions Workflow Using VS Code</span>

### <span style="color: CadetBlue;Font-family: Segoe UI, sans-serif;">Create a New Repository Using GitHub Desktop</span>
...
<img src="images/2024-08-07-20-57-35.png" alt="alt text" style="
...
<img src="images/2024-08-07-21-02-39.png" alt="alt text" style="
    border: 2px solid gray;
    border-radius: 6px;
    box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2);
    margin: 20px;
...
<img src="images/2024-08-07-21-08-21.png" alt="alt text" style="
  border: 2px solid gray;
  border-radius: 6px;
  box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2);
  margin: 20px;
...
### <span style="color: CadetBlue;Font-family: Segoe UI, sans-serif;">Set Up the GitHub Actions Workflow in VS Code</span>
...
<img src="images/2024-08-07-21-15-42.png" alt="alt text" style="
  border: 2px solid gray;
  border-radius: 6px;
  box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2);
  margin: 20px;
...
### <span style="color: CadetBlue;Font-family: Segoe UI, sans-serif;">Create a Python Script</span>
  ...
  - Add the following code to `hello.py`:
    ...
    ```
<img src="images/2024-08-07-21-21-38.png" alt="alt text" style="
  border: 2px solid gray;
  border-radius: 6px;
  box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2);
  margin: 20px;
...
### <span style="color: CadetBlue;Font-family: Segoe UI, sans-serif;">Commit and Push the Changes</span>
...
<img src="images/2024-08-07-21-24-04.png" alt="alt text" style="
  border: 2px solid gray;
  border-radius: 6px;
  box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2);
  margin: 20px;
...
### <span style="color: CadetBlue;Font-family: Segoe UI, sans-serif;">Check the Workflow Execution</span>
...
<img src="images/2024-08-07-21-38-54.png" alt="alt text" style="
  border: 2px solid gray;
  border-radius: 6px;
  box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2);
  margin: 20px;
