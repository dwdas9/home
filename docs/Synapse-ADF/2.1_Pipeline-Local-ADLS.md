...
| 2: Install SHIR on Laptop            | Self-hosted Integration Runtime (SHIR)     | A software installed on your laptop to enable data movement from on-premises to the cloud. [More details on Integration Pipelines](1.5_IntegrationRuntime.md)    |
