...
| **Installation**                | Download and install the .msi file  on your machine ![alt text](images/image-2.png)|Same, the .exe needs to be downloaded to your local computer and installed. Just like good-old .exe installation. ![alt text](images/image.png)|
