...
3. **Hive** — SQL over big data: why it exists, schema-on-read, and the metastore. *(Module 2.)*
...
You have finished Module 0. You can now answer, from first principles, *why* the big-data ecosystem exists and *what problems* every part of it is fighting. That is genuinely the hardest conceptual step — everything after this is detail hanging off a frame you now hold in your head.
